const Life = () => {
  return (
    ...
    <div className="w-full h-full relative">
      ...
      <div
        className="absolute left-[20%] md:left-auto md:right-[10%] lg:right-1/4 xl:right-1/4 bottom-16 md:bottom-auto md:top-20 xl:top-20
    ...
    <div className="text-white w-1/2">
      <h3>My name is Atefeh hasani</h3>
      <p>I born in 1999 at Tehran. </p>
    </div>
    </div>
  );
};
